...
class SessionManager {
    ...
    createUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { name, lastname, username, email, password, repeat_password, profilePicture, isCritic, } = req.body;
            ...
            yield (0, express_validator_1.check)("isCritic").optional().run(req);
